...
export default class Floor {
    ...
    setCircles() {
        ...
        const material = new THREE.MeshStandardMaterial({ color: 0xdbc1ac });
        const material2 = new THREE.MeshStandardMaterial({ color: 0xb99a83 });
        const material3 = new THREE.MeshStandardMaterial({ color: 0x967259 });
